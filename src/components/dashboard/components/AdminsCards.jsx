...
const AdminsCards = ({ data }) => {
  return (
    <>
      <div className='  flex flex-col  items-center justify-center'>
        <div className='bg-gray-100  w-[110vh]  dark:bg-gray-700 relative shadow-xl overflow-hidden hover:shadow-2xl group rounded-xl p-5 transition-all duration-500 transform'>
          <div className='flex items-center gap-4'>
            ...
            <div className='w-fit transition-all transform duration-500'>
              ...
              <p className='text-gray-400'>{data.fulName}</p>
              <p>{data.branch}</p>
              <p>{data.subs}</p>

              <a className='text-xs text-black dark:text-gray-200 group-hover:opacity-100 opacity-0 transform transition-all delay-300 duration-500'>
                mary@gmail.com
              </a>
            </div>
          </div>
